        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12 card">
                    ...
                    <div>
                        <form role="form" action="{{ route('backend.users.update', $user->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" placeholder="Enter email" name="email" value="{{ old('email')?old('email'):$user->email }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="isadmin" class="form-control" id="isadmin">
                                        ...
                                        <option value="0" {{ old('isadmin') == false || $user->is_admin == false?'selected':'' }}>No</option>
                                        <option value="1" {{ old('isadmin') == 1 || $user->is_admin == 1?'selected':'' }}>Yes</option>
                                    </select>
                                </div>
